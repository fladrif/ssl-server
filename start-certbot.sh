...
certbot certonly --noninteractive --agree-tos --domains battle.jonathan.li --email webmaster@renderjon.li --nginx
certbot certonly --noninteractive --agree-tos --domains rachel.jonathan.li --email webmaster@renderjon.li --nginx
